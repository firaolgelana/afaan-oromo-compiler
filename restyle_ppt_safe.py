...
# We will NOT delete existing slides to avoid PPTX corruption (which causes the "password required" bug).
# We will just append the new slides at the end.
...
print("Safe styled presentation generated successfully!")
